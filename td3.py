...
class Actor(nn.Module):
    ...
    def forward(self, x):
        x = F.relu(self.l1(x))
        x = F.relu(self.l2(x))
        x = np.diff(self.action_bounds)[0] * torch.tanh(self.l3(x)) + np.mean(self.action_bounds)
        return x
...
class TD3(object):
    ...
    def __init__(self, state_dim, action_dim, action_bounds, env):
...
class Runner():
    ...
    def next_step(self, episode_timesteps, noise=0.1):
        ...
        replay_buffer.add((self.obs, action, new_obs, reward, done_bool))
